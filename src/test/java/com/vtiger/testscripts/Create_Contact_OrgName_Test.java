...
public class Create_Contact_OrgName_Test {
    public static void main(String[] args) throws IOException {
        ...
        // Click on plus icon next to organization name
        driver.findElement(By.xpath("//img[@title='Select']")).click();

        // switch to organizations window
        ...
        // Fetch the orgname from excel file
        String porgname = wb.getSheet("Sheet1").getRow(3).getCell(2).toString();
        wb.close();
        td.close();

        // Enter the previous orgname in search txtfld
        driver.findElement(By.xpath("//input[@name='search_text']")).sendKeys(porgname);
