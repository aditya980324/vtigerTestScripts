...
public class Create_Org_OrgName_Phone_Test {
    public static void main(String[] args) throws IOException {
        ...
        int num=10;
        String numop="1234567890";
        StringBuilder sb=new StringBuilder(numop);
        for (int i=0;i<=num;i++){
            int index=(int)(numop.length()*Math.random());
            sb.append(numop.charAt(index));
        }
        System.out.println("Generated phone no - "+sb);

        // Enter the phone number in phone txtfld
        driver.findElement(By.name("phone")).sendKeys(sb);
